...
namespace NETCoreMVC_Notlarim.Controllers
{
    public class ProductController : Controller
    {
        ...
        //                              ----DEPENDENCY INJECTION / IOC YAPILANMASI-----

        // DEPENDENCY INJECTION ;

        // BAGIMLILIKLARI SOYUTLAMAK DEMEKTEDIR
        // SOLID PRENSIPLERINDEKI "D" : DEPENDENCY INVERSION (BAGIMLILIKLARIN TERSINE CEVRILMESI)
        // ICIN YAPILMASI GEREKEN BIR DESIGN PATTERN
        // ORNEGIN A SINIFININ B SINIFINA IHTIYACI OLDUGUNDA B SINIFINI A SINIFINDAN NEWLEMEKTEN KACINMAK
        // A NIN B YE OLAN BAGIMLIGINI MUMKUM OLDUGUNCA SOYUTLAMAYA DEP.INJ. DENIR
        // BUNUN ICIN ORTAK BIR SINIF OLUSTURUP O SINIFI YA CONSTRUCTORDEN PARAMETREYLE YA DA SETTER METHODLA ALMAYI TERCIH EDERIZ
        // Otobus:IArac ,Taksi:IArac

        //(IoC) IOC YAPILANMASI ;

        // BAZI DURUMLARDA SINIFIMIZ ICERISINDE COK SAYIDA ARAYUZE REFERANS VERMEMIZ GEREKEBILIR
        // BU DURUMDA OTOMATIK GERCEKLESEN BIR YAPI KURMAMIZ GEREKIR BU DA IOCTUR
        // DEP.INJ KULLANILARAK ENJEKTE EDILECEK OLAN TUM NESNELER IOC CONTAINER SINIFLARINDAN TUTULUR
        // IHTIYAC DOGRULTUSUNDA CAGIRILIR
        ...
        //SCOPED ;
        //  HER REQ BASINA BIR NESNE URETIR VE O REQ PIPELINENINDA OLAN TUM ISTEKLERE O NESNEYI GONDERIR.
